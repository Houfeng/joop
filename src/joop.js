...
function $import(pathList, callback, importType) {
 ...
 * @return {void}             无返回值
 */
$import.addElement = function(_element) {
 ...
 */
$import.handlePath = function(_path) {
 ...
 */
$import.createScript = function(_url) {
 ...
 */
$import.createStyle = function(_url) {
